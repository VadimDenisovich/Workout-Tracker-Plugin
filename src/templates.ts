...
### [[Exercises/Румынская тяга с гантелями|Румынская тяга с гантелями]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Двойная верхняя тяга блока в груди|Двойная верхняя тяга блока в груди]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Подъемы с гантелями|Подъемы с гантелями]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Французский жим с нижнего блока|Французский жим с нижнего блока]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Подъем гантелей на дельты|Подъем гантелей на дельты]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Жим ногами на носки|Жим ногами на носки]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз

{{exercise:Жим ногами на носки}}

### [[Exercises/Тверк|Тверк]]
Подход 1: _ раз
Подход 2: _ раз

{{exercise:Тверк}}

### [[Exercises/Пилатес|Пилатес]]
Подход 1: _ раз
Подход 2: _ раз

{{exercise:Пилатес}}

### [[Exercises/Гоблет-присед с гантелью|Гоблет-присед с гантелью]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз

{{exercise:Гоблет-присед с гантелью}}
...
### [[Exercises/Жим от груди в Смите|Жим от груди в Смите]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Подъём гантелей на дельты лежа|Подъём гантелей на дельты лежа]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Разгибание ног в тренажере|Разгибание ног в тренажере]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Подъем EZ-штанги на бицепс стоя|Подъем EZ-штанги на бицепс стоя]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Скручивание на пресс на скамье|Скручивание на пресс на скамье]]
Подход 1: _ раз
Подход 2: _ раз
Подход 3: _ раз
...
### [[Exercises/Жим штанги лёжа узким хватом|Жим штанги лёжа узким хватом]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Становая тяга классика (средний вес)|Становая тяга классика (средний вес)]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Тяга горизонтального блока к поясу|Тяга горизонтального блока к поясу]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Жим гантелей на наклонной скамье (45°)|Жим гантелей на наклонной скамье (45°)]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Разгибания рук с гантелью из-за головы (французский жим сидя)|Разгибания рук с гантелью из-за головы (французский жим сидя)]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Подъёмы ног в висе|Подъёмы ног в висе]]
Подход 1: _ раз
Подход 2: _ раз
...
### [[Exercises/Гиперэкстензия (икры)|Гиперэкстензия (икры)]]
Подход 1: _ кг x _ раз
Подход 2: _ кг x _ раз
...
### [[Exercises/Отжимания|Отжимания]]
_ раз

{{exercise:Отжимания}}

### [[Exercises/Приседания|Приседания]]
_ раз

{{exercise:Приседания}}

### [[Exercises/Пресс|Пресс]]
_ раз
...
Упражнение без веса — фиксируй только количество повторений
